    ...
    <div className="hero" style={backgroundStyle}>
      ...
      <div className="hero__content">
        <h1 className="hero__h1">
          {firstAccess
            ? hero.title.first_time_accessing
            : hero.title.second_time_accessing}
        </h1>
        <p className="hero__p">{hero.subtitle}</p>
        <button className={`hero__btn ${buttonClass}`}>
          {firstAccess
            ? hero.button_label.first_time_accessing
            : hero.button_label.second_time_accessing}
        </button>
      </div>
